...
Face Authentication System which includes state-of-art algorithms like MTCNN and FaceNet to detect face and generate face embedding. This system contains endpoints which can be integrated to any device depending on the requirements. 
...
```
git clone https://github.com/vineet1409/Face-Authenticator-Security-System.git
```
